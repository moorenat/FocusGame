Below is the prompt for the original project as given to me from my instructors. We have permission to make these projcets public as they will not be re using
the material. I am currently working on creating a GUI for the functional game using KIVY in my spare time between working full time and taking 8 credits per term.
See bottom of readme for example of how to play the game. 
